...
export default function Cart() {
    ...
    return (
        <>
            <button data-testid="open-cart-button" aria-label="Open cart" onClick={openCart}>
                ...
                >
                    {cart?.lines.length === 0 ? (
                        <Box mt={10} display="flex" flexDirection="column" alignItems="center">
                            <ShoppingCartIcon sx={{fontSize: 48, color: highContrast ? "yellow" : "inherit"}}/>
                                        ...
                                        <div className="flex items-start justify-between gap-4 px-1 py-4">
                                            ...
                                            <div className="flex flex-1 flex-col justify-between">
                                                ...
                                                <div className="mt-2 flex items-center justify-between">
                                                    <Price className="text-sm font-medium" amount={item.unitAmount}/>
                                                    <div
                                                    ...
                                                    >
                                                        ...
                                                        <span className="w-6 text-center text-sm"
                                                              data-testid="cart-item-qty">{item.quantity}</span>
