                          ...
                          <div
                              onClick={async () => {
                                try {
                                  ...
                                  toast.success("✅ " + intl.formatMessage({ id: "order.statusUpdate.success" }), {
                                    description: intl.formatMessage({ id: `order.status.${nextStatus}` }),
                                  });
                                  setOrder(updated);
                                } catch (err: any) {
                                  toast.error("❌ " + intl.formatMessage({ id: "order.statusUpdate.error" }), {
                                    description: err?.message || intl.formatMessage({ id: "order.statusUpdate.retry" }),
                                  });
                                }
                              }}
                              onMouseEnter={(e) => {
                                e.currentTarget.querySelector(".MuiChip-root")!.style.filter = "brightness(0.9)";
                              }}
                              onMouseLeave={(e) => {
                                e.currentTarget.querySelector(".MuiChip-root")!.style.filter = "";
                              }}
