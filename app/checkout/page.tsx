    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
            <div className="w-full md:w-1/2 p-6 md:p-12">
                <h2 className="text-xl font-bold mb-6 text-[var(--color-text-strong)]">Contact</h2>
                <input
                    type="text"
                    placeholder="Email"
                        ...
                        {cart.lines.map((item) => (
                            <li key={item.id} className="flex items-center mb-4">
                                ...
                                <div className="ml-4 flex-1">
                                    <h3 className="font-semibold text-sm md:text-base">{item.merchandise.product.title}</h3>
